...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="adm_agregarEstudiante.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-sm text-white-50"></i>Agregar Estudiante</a>
  </div>
  <p class="mb-4">Estudiantes con cuenta a la fecha: <c:out value="${fecha}"></c:out></p>
  <div class="card-header py-3 alert-warning">
    <h2 class="h4 text-gray-900 mb-4">Se ha AGREGADO el ESTUDIANTE con exito.</h2>
  </div>
