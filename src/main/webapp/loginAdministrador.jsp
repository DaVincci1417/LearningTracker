                ...
                <form class="user" action="loginAdministrador" method="post">
                  <div class="form-group">
                    <input type="email" class="form-control form-control-user"
                           id="rutLoginAdministrador" name="rutLoginAdministrador" aria-describedby="emailHelp"
                           placeholder="Ingresa tu RUT" required>
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control form-control-user"
                           id="contraseñaAdministrador" name="contraseñaAdministrador" placeholder="Contraseña" required>
                  </div>
