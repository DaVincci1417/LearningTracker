...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modificar Evento</h1>
    </div>
        ...
        <div class="card-body">
            <form class="user" action="adm_modificarEvento" method="post">
                ...
                <div class="form-group ">
                    <textarea class="form-control" id="descripcion_evento" name="descripcion_evento" placeholder="Descripcion Evento" rows="10" required><%=evento.getDescripcionEvento()%></textarea>
                </div>
                <!-- Divider -->
