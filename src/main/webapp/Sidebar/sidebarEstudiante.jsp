...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="est_panel.jsp">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="est_verApuntes.jsp">
    ...
    <!-- Nav Item - Ramos_Semestre Collapse Menu -->
    <li class="nav-item active">
      <a type="submit" class="nav-link" href="est_verEventos.jsp">
        <i class="fas fa-window-restore"></i>
        <span>Eventos</span></a>
    </li>
    <!-- Divider -->
