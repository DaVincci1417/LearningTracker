...
@WebServlet(name = "est_obtenerAsignaturaServlet", value = "/est_obtenerAsignatura")
public class est_obtenerAsignaturaServlet extends HttpServlet {
    @Override
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
        if(req.getParameter("cod_asignatura").length() != 0){
            ...
            try {
                ...
                response.sendRedirect("est_verAsignatura.jsp");
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
        }
